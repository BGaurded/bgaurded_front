...
import { ArrowLeft, Shield, RefreshCw, Search, AlertTriangle, ExternalLink, CheckCircle, ChevronDown, ChevronUp, Lock, FileDown } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import AgentProfileCard from '@/components/intelligence/AgentProfileCard';
import ExportModal from '@/components/intelligence/ExportModal';
    ...
    <div className="min-h-screen flex bg-[#05080f]" style={{ fontFamily: 'var(--font-inter)' }}>
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-5 sm:px-8 xl:px-12 py-8 space-y-6">
          ...
          {/* Export modal */}
          <ExportModal isOpen={exportOpen} onClose={() => setExportOpen(false)} agentId={agentId} />
          ...
          <div className="flex items-end justify-between">
            ...
            <div className="flex items-center gap-3">
              <span className="text-[10px] font-mono text-white/15 hidden sm:block">{agentId}</span>
              <button
                onClick={() => setExportOpen(true)}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-cyan-400 hover:text-cyan-300 transition-colors"
