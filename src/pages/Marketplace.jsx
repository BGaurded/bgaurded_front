    ...
    <div className="bg-[#070b12] min-h-screen relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-14">
          <p className="text-xs font-mono text-cyan-400 tracking-widest uppercase mb-4">Community Registry</p>
          <h1 className="font-syne font-bold text-4xl md:text-5xl text-white mb-5 leading-tight">
            BGaurded Verified Agent Marketplace
          </h1>
          <p className="text-white/40 text-lg max-w-2xl mx-auto leading-relaxed">
            Agents listed here have verified on-chain proof of their actions, trust scores, and compliance exports. Built by the community. Governed by BGaurded.
          </p>
        </motion.div>
